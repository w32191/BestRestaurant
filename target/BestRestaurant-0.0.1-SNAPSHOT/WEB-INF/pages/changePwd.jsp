		...
		<div class="templatemo-content col-1 light-gray-bg">
			...
			<div class="templatemo-content-container">
				<div class="templatemo-content-widget white-bg">
					...
					<form action="doChangePwd" class="templatemo-login-form"
						method="post">
						...
						<div class="row form-group">
							<div class="col-lg-8 col-md-8 form-group">
								<label for="inputCurrentPassword">請輸入舊密碼</label> <input
									type="password" class="form-control" id="inputCurrentPassword"
									name="inputCurrentPassword" placeholder="********"> <span
									id="checkSpan01"></span>
							</div>
						</div>
						<div class="row form-group">
							<div class="col-lg-8 col-md-8 form-group">
								<label for="inputNewPassword">請輸入新密碼：</label> <input
									type="password" class="form-control" id="inputNewPassword"
									name="inputNewPassword" placeholder="********"> <span
									id="checkSpan02"></span>
							</div>
						...
						<div class="row form-group">
							<div class="col-lg-8 col-md-8 form-group">
								<label for="inputConfirmNewPassword">再次輸入你的新密碼：</label> <input
									type="password" class="form-control"
									id="inputConfirmNewPassword" name="inputConfirmNewPassword"
									placeholder="********"> <span id="checkSpan03"></span>
							</div>
						</div>
